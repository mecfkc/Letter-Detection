...
for imagePath in imagePaths:
	...
	# labels list
	# labels include: UH8, L6R, G7C, S1P, JW3, A2X
...
H = model.fit_generator(aug.flow(trainX, trainY, batch_size=7),
validation_data=(testX, testY), steps_per_epoch=len(trainX) // 7,
epochs=50, verbose=1)
